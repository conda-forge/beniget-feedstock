...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/beniget-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6522&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/beniget-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `beniget` can be installed with:

```
conda install beniget
```

It is possible to list all of the versions of `beniget` available on your platform with:
